...
sheet, ticks_per_beat, _ = midi2sheet(Path(r'midis/nightingale.mid'))
...
pr.draw_pianoroll(height=8, aspect_note=2, dpi=72, type='piano')
...
plt.savefig('pianoroll_new_test.svg', bbox_inches='tight')
