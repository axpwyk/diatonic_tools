...
for i in range(N):
    ...
    w, h = g.draw_guitar(height=6, hue=0.01+0.075*i, low=-1, high=24, finger_offset=offsets[i], radius_offset=-1)
...
tpl.save('guitar_test.tikzpicture', figurewidth=f'{w}cm', figureheight=f'{h}cm')
plt.close()
